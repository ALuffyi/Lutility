...
👉 [Lutility-Setup-2.14.1.exe](https://github.com/ALuffyi/Lutility/releases/latest/download/Lutility-Setup-2.14.1.exe)
...
1. Télécharger `Lutility-Setup-2.14.1.exe`
...
```
Produit : `dist/Lutility-Setup-2.14.1.exe` (NSIS x64)
